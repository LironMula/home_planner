...
- Reconstruct the master walk-in closet as two opposing 3.25 m ceiling-height open wardrobe banks, 0.45 m and 0.60 m deep, with a 0.90 m clear aisle. The centered light-cream 1.00 m opening is the master-suite entry and must lead directly into that aisle.
