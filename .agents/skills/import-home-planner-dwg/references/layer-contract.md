...
Source inspection also found stair direction triangles and additional window-frame lines on **A13**, and hidden return-flight/elevator geometry on **H**. Inspect these as supplementary evidence; they do not replace the user's primary floor and wall mapping. A14 also contains projected stair graphics, so identify which floor connection each tread cluster describes before assigning it to a flight. The earlier interpretation that living AREA 1575 was the outgoing upper stair was incorrect; the verified adjacent-flight findings below supersede it.
...
- The later stair clarification supersedes the earlier stacked-stair request. On the living sheet, AREA **1575** encloses the incoming lower stair, while A14 **1886/1899** and H **188E/188C/1583** establish the adjacent outgoing U stair. Its return aligns with top-floor **139A** and A13 **132A/132B**. H contains essential supplementary geometry here; the user-provided primary layer map is not an exclusion list.
- The elevator reservation is on **H**, with equal 1.00 x 1.50 m contours **11DF/22AD/1D5D/1546** on the four sheets and A49 elevator label **1D4E**. Treat it as an independent aligned shaft through the intermediate floor/ceiling slabs, with the basement floor retained as its base and the roof retained above. Top-floor A17 **1568/1564/1538** already encloses it. The red X on H **1251/1252** marks the unusable continuation of the lower stair, not a placed upper flight. Verify these meanings from labels and cross-sheet geometry; do not generalize every red X into a void or every H entity into an elevator.
